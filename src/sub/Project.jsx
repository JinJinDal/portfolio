...
function Project({data}) {
    ...
    const renderPro = () => {
        ...
        return Projects.map((item) => (
            <article key={item.id}>
                <div className='sct3-img-container'>
                    <div className='project-pc-img'><img src={item.imgWb} alt="" /></div>
                    <div className='project-mb-img'><img src={item.imgMb} alt="" /></div>
                </div>
